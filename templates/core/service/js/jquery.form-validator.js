...
(function ($) {
  ...
  $.formUtils = {
     ...
     */
    LANG: {
      errorTitle: 'ارسال فرم انجام نشد!',
      requiredFields: 'شما به همه فیلد های مورد نیاز پاسخ نداده اید',
      badTime: 'زمان شما صحیحی نمی باشد',
      badEmail: 'ایمیل شما صحیح وارد نشده است',
      badTelephone: 'تلفن شما صحیح وارد نشده است',
      badSecurityAnswer: 'شما به سوال امنیتی جواب درستی نداده اید',
      badDate: 'تاریخ شما صحیح وارد نشده است',
      lengthBadStart: 'مقدار ورودی باید بین باشد ',
      lengthBadEnd: ' کاراکترها',
      lengthTooLongStart: 'مقداری که شما وارد کرده اید بیشتر از ',
      lengthTooShortStart: 'مقداری که شما وارد کرده اید کوتاه تر از',
      notConfirmed: 'مقادیر ورودی را نمی توان تأیید کرد',
      badDomain: 'دامنه صحیح نمی باشد',
      badUrl: 'مقدار ورودی URL صحیح نیست',
      badCustomVal: 'مقدار ورودی نادرست است',
      andSpaces: ' و فضای خالی  ',
      badInt: 'مقدار ورودی عدد صحیحی نبود',
      badSecurityNumber: 'شماره تأمین اجتماعی شما نادرست بود',
      badUKVatAnswer: 'شماره مالیات بر ارزش افزوده بریتانیا نادرست',
      badStrength: 'پسورد شما قوی نیست',
      badNumberOfSelectedOptionsStart: 'حداقل باید انتخاب کنید ',
      badNumberOfSelectedOptionsEnd: ' جواب',
      badAlphaNumeric: 'مقدار ورودی فقط می تواند شامل نویسه های الفبایی باشد ',
      badAlphaNumericExtra: ' و ',
      wrongFileSize: 'پرونده ای که می خواهید بارگذاری کنید بسیار بزرگ است (حداکثر٪ s)',
      wrongFileType: 'فقط پرونده هایی از نوع٪ s مجاز است',
      groupCheckedRangeStart: 'لطفا یکی را انتخاب کنید ',
      groupCheckedTooFewStart: 'لطفا حداقل را انتخاب کنید ',
      groupCheckedTooManyStart: 'لطفا حداکثر را انتخاب کنید ',
      groupCheckedEnd: ' item(s)',
      badCreditCard: 'شماره کارت اشتباه است',
      badCVV: 'شماره cvv اشتباه است',
      wrongFileDim : 'ابعاد تصویر نادرست است,',
      imageTooTall : 'طول تصویر نمی تواند بلندتر از',
      imageTooWide : 'عرض تصویر نمی تواند گسترده تر از',
      imageTooSmall : 'تصویر بسیار کوچک است',
      min : 'مینیموم',
      max : 'ماکسیموم',
      imageRatioNotAccepted : 'نسبت تصویر پذیرفته نمی شود'
    }
  };
